...
export const Appbar = () => {
  ...
  return <div className="border-b flex justify-between px-10 py-4">
    ...
    <div>
      <Link to={'/myblogs'}>
      <button type="button" className="text-white bg-purple-700 hover:bg-purple-800 focus:outline-none focus:ring-4 focus:ring-purple-300 font-medium rounded-full text-sm px-5 py-2.5 me-3 text-center mb-2 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900">My Blogs</button>
